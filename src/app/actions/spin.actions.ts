...
export class SizeChange implements Action {
  readonly type = SpinActionTypes.SizeChange;

  constructor(public payload: SizeChangePayload) {}
}

export interface SizeChangePayload {
  size: number;
}
